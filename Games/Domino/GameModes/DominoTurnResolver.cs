...
{
    internal const int ActionRequestsPerSecond = 10;
    ...
    private void PlayTileOnServer(int turnToken, int tileId, int end)
    {
        ...
        TryPlayTile(requesterId, turnToken, tileId, end);
    }
    ...
    private void DrawTileOnServer(int turnToken, int slot)
    {
        ...
        TryDrawTile(requesterId, turnToken, slot);
    }
