...
public partial class GameStarting : State
{
    ...
    private void OnTimeEnds()
    {
        ...
        // Recheck the server's physics world after the countdown. Client prediction never writes
        // these transforms, so walking away really removes a player from the authoritative area.
